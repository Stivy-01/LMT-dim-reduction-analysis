...
def get_db_path():
    """GUI-based database file selection with folder support"""
    root = tk.Tk()
    root.withdraw()
    ...
    choice = tk.messagebox.askquestion(
        "Processing Mode",
        "Would you like to process multiple files?",
        icon='question',
        detail="Select 'Yes' for multiple files/folders, 'No' for single file"
    )
    ...
    files = filedialog.askopenfilenames(
        title="Select SQLite Database File(s)",
